...
**What it deliberately does not do.** Games and verse practice have routes and honest "still being made" states rather than interactions, because Ordering and Discovery are Milestones 5 and 6 and jumping them to fill a screen would have been the wrong trade.
